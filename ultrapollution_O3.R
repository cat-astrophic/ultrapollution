...
mod50k <- lm(log(Seconds+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
             ...
             + Education_Bachelors + Education_Graduate + Altitude_Home + O3_Home,
             data = data[which(data$RACE_Distance == '50 KM'),])

mod50m <- lm(log(Seconds+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
             + WindSpeed + factor(FIPS_Race) + factor(RACE_Month)*factor(RACE_Year)
             + Total_Races + RACE_Finisher_Count + In_State
             + Travel_Distance + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
mod100k <- lm(log(Seconds+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
              + WindSpeed + factor(FIPS_Race) + factor(RACE_Month)*factor(RACE_Year)
              + Total_Races + RACE_Finisher_Count + In_State
              + Travel_Distance + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
              + Education_High_School + Education_Some_College + Education_Associates
...
mod100m <- lm(log(Seconds+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
              + WindSpeed + factor(FIPS_Race) + factor(RACE_Month)*factor(RACE_Year)
              + Total_Races + RACE_Finisher_Count + In_State
              + Travel_Distance + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
              + Education_High_School + Education_Some_College + Education_Associates
...
mod6h <- lm(log(Distance+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
            + WindSpeed + factor(FIPS_Race) + factor(RACE_Month)*factor(RACE_Year)
            + Total_Races + RACE_Finisher_Count + In_State
            + Travel_Distance + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
mod12h <- lm(log(Distance+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
             + WindSpeed + factor(FIPS_Race) + factor(RACE_Month)*factor(RACE_Year)
             + Total_Races + RACE_Finisher_Count + In_State
             + Travel_Distance + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
mod24h <- lm(log(Distance+.001) ~ O3 + factor(Gender) + Temperature*Humidity + Precipitation
             + WindSpeed + factor(FIPS_Race) + factor(RACE_Month)*factor(RACE_Year)
             + Total_Races + RACE_Finisher_Count + In_State
             + Travel_Distance + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
write.csv(stargazer(xmod50k, xmod50m, xmod100k, xmod100m, xmod6h, xmod12h, xmod24h,
          ...
          paste(direc2, 'O3_results_tex.txt', sep = ''), row.names = FALSE)

write.csv(stargazer(xmod50k, xmod50m, xmod100k, xmod100m, xmod6h, xmod12h, xmod24h, type = 'text',
                    omit = c('FIPS_Race', 'RACE_Name', 'RACE_Month', 'RACE_Year')), 
          paste(direc2, 'O3_results.txt', sep = ''), row.names = FALSE)
