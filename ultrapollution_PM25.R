...
modd1 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
...
modd2 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd3 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd4 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd5 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd6 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd7 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd8 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd9 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modd10 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd11 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd12 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd13 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd14 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd15 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd16 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd17 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd18 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modd19 <- lm(log(Seconds) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
             + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
             + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
             + Education_High_School + Education_Some_College + Education_Associates
...
modt1 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt2 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt3 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt4 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt5 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt6 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt7 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt8 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
modt9 <- lm(log(Distance) ~ PM2.5 + factor(FIPS_Race) + factor(RACE_Name) + factor(RACE_Month)*factor(RACE_Year)
            + factor(Gender) + Total_Races + RACE_Finisher_Count + In_State + Travel_Distance
            + Ability + Population + Poverty_Rate + Unemployment_Rate + Income
            + Education_High_School + Education_Some_College + Education_Associates
...
write.csv(stargazer(modd1, modd2, modd3, modd4, modd5, modd6, modd7, modd8, modd9, modd10,
          ...
          paste(direc2, 'PM_db.txt', sep = ''), row.names = FALSE)
...
write.csv(stargazer(modt1, modt2, modt3, modt4, modt5, modt6, modt7, modt8, modt9,
                    ...
                    omit = c('FIPS_Race', 'RACE_Name', 'RACE_Month', 'RACE_Year'),
                    omit.stat = c('f', 'ser'), type = 'text'),
          paste(direc2, 'PM_tb.txt', sep = ''), row.names = FALSE)
